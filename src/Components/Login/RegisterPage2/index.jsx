...
const schema = Yup.object({
  phone: Yup.string().when("step", {
    is: "login",
    then: (s) => s.required(" کد تایید الزامی است"),
  }),
  ...
  return (
    ...
    >
      <div className="w-full max-w-md p-10 relative">
        ...
        <h1 className="text-3xl font-semibold text-center"> دریافت کد </h1>
        <br />
        <h2 className="ml-20">کدی که برای تان ارسال کردیم را وارد کنید </h2>
          ...
          {({ values, errors, touched }) => (
            <Form className="flex flex-col gap-6 mt-8">
              ...
              <NavLink to="/Register3">
                ...
                >
                  {values.step === "login" ? "تایید کد" : "تایید کد"}
                </button>
              </NavLink>
            </Form>
          )}
